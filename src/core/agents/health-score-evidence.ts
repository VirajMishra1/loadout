...
import { DEFAULT_ACTIVE_SKILL_LIMIT } from "../workspace/active-limit.js";
...
import { readLocalOutcomes } from "../workspace/outcomes.js";
import { readSnapshot } from "../install/snapshot.js";
import { scanInstalledSkills } from "../catalog/skill-inventory.js";
import { readInstallState } from "../workspace/state.js";
import { transactionRoot } from "../install/transaction.js";
